...
# l'erreur d'install_underwater_calibration.py qui a suivi les premieres mesures du bassin
...
# Le montage physique de la machine, ecrit une fois par set_mounting.py.
...
def main():
    ...
    def _meme_optique(ligne):
        """La ligne a-t-elle ete mesuree avec CETTE optics-la ?"""
