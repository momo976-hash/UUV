...
# Lancer `calibration.py` SANS l'option --montage ecrit sous le nom par
...
# 5_Nos_chiffres de documents/fonction_calibration.xlsx et dans l'en-tete de
...
fichier = optique.DOSSIER_MONTAGES / "tube_air.npz"
...
print("\nVerifie avec :  python calibration/optique.py")
