"""sensibilite_reglages.py — Quels reglages comptent VRAIMENT, et quand.

POURQUOI CE SCRIPT
Le protocole (documents/protocole_kalman.md) demande de mesurer quatre
...
Dans filtre_kalman.py, les deux parametres sont sur une branche `is None` :
...
from filtre_kalman import (FiltrePose, angle_quaternions,  # noqa: E402
